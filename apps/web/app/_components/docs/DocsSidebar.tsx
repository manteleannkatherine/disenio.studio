...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/docs/pairs#filter-bar", label: "FilterBar" },
      { href: "/docs/pairs#empty-state", label: "EmptyState" },
      { href: "/docs/pairs#stat-card", label: "StatCard" },
      { href: "/docs/pairs#auth-card", label: "AuthCard" },
      { href: "/docs/pairs#page-heading", label: "PageHeading" },
      { href: "/docs/pairs#comment-row", label: "CommentRow" },
      { href: "/docs/pairs#price-card", label: "PriceCard" },
    ],
  },
  {
    title: "Components",
